...
void NRF24_write(uint8_t Adr, uint8_t data){
	Adr |= W_REGISTER;
	uint8_t Buffer[2] = {Adr, data};
	NRF24_select();
	HAL_SPI_Transmit_DMA(SPI_NRF24, Buffer, 2);
	NRF24_unselect();
}
...
void NRF24_DefaultConfiguration(void){
	NRF24_Configurations_Struct.Actual.CONFIG 			= 0x08;
	NRF24_Configurations_Struct.Actual.EN_AA  			= 0x3F;
	NRF24_Configurations_Struct.Actual.EN_RXADDR  		= 0x03;
	NRF24_Configurations_Struct.Actual.SETUP_AW  		= 0x03;
	NRF24_Configurations_Struct.Actual.SETUP_RETR 		= 0x00;
	NRF24_Configurations_Struct.Actual.RF_CH  			= 0x02;
	NRF24_Configurations_Struct.Actual.RF_SETUP  		= 0x0F;
	NRF24_Configurations_Struct.Actual.STATUS  			= 0X0E;
	NRF24_Configurations_Struct.Actual.OBSERVE  		= 0X00;
	NRF24_Configurations_Struct.Actual.CD  				= 0x00;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P0[0]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P0[1]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P0[2]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P0[3]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P0[4]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P1[0]   	= 0xC2;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P1[1]   	= 0xC2;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P1[2]   	= 0xC2;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P1[3]   	= 0xC2;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P1[4]   	= 0xC2;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P2  		= 0xC3;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P3 		= 0xC4;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P4  		= 0xC5;
	NRF24_Configurations_Struct.Actual.RX_ADDR_P5  		= 0xC6;
	NRF24_Configurations_Struct.Actual.TX_ADDR[0]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.TX_ADDR[1]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.TX_ADDR[2]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.TX_ADDR[3]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.TX_ADDR[4]   	= 0xE7;
	NRF24_Configurations_Struct.Actual.RX_PW_P0  		= 0X00;
	NRF24_Configurations_Struct.Actual.RX_PW_P1  		= 0X00;
	NRF24_Configurations_Struct.Actual.RX_PW_P2  		= 0X00;
	NRF24_Configurations_Struct.Actual.RX_PW_P3  		= 0X00;
	NRF24_Configurations_Struct.Actual.RX_PW_P4  		= 0X00;
	NRF24_Configurations_Struct.Actual.RX_PW_P5  		= 0X00;
...
void NRF24_config(NRF24_Address_Configurations_t Configuration_struct){
	...
	uint8_t RX_ADDR_P0_ADDRESS[5]={0xC5,0xC5,0xC5,0xC5,0xC5};
	uint8_t RX_ADDR_P1_ADDRESS[5]={0x2C,0x2C,0x2C,0x2C,0x2C};
	uint8_t TX_ADDR_ADDRESS[5]={0xC5,0xC5,0xC5,0xC5,0xC5};
